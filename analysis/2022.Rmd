...
```{r out.width="100%", fig.cap="Figure: Logo.",fig.align='center', echo=TRUE}
knitr::include_graphics(c("asset/logo.png"), error = FALSE)
```
...
Link to [file](../docs/assets/logo.png) by `[file](../docs/assets/logo.png)`.
