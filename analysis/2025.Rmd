...
![](assets/network_snp.pdf){width="80%"}
...
![](assets/network_gene.pdf){width="80%"}
...
2. **Perform Perturb-seq for trans-effects**
   - Utilize **CRISPRi**
   - Direct application in **COTA analysis** ([Nature Link](https://www.nature.com/articles/s41586-024-07022-x))
