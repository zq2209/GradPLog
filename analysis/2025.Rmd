...
![](assets/perturb_pval_hist.png){width="50%"}

![](assets/perturb_pval_qq.png){width="50%"}

**Distribution of p-value for GWAS pairs** 

![](assets/perturb_pval_hist_gwas_genes.png){width="50%"}

![](assets/perturb_pval_qq_gwas_genes.png){width="50%"}
...
|           | DNMT3A      | TNFRSF6B    |
|-----------|------------|------------|
| Min       | 0.0000489864 | 0.000121661 |
| Max       | 0.9990190000 | 0.999877000 |
| Mean      | 0.5010033048 | 0.489069067 |
| Median    | 0.4999820000 | 0.471279000 |
| SD        | 0.2954533975 | 0.306062442 |
...
|           | ATG4C      | SBNO2      |
|-----------|-----------|-----------|
| Min       | 0.000533211 | 0.000259479 |
| Max       | 0.999828000 | 0.997488000 |
| Mean      | 0.491614086 | 0.507823398 |
| Median    | 0.489878000 | 0.492926000 |
| SD        | 0.292780373 | 0.296452133 |
...
![](assets/network_perturb.png){width="90%"}
