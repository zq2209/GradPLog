...
df <- data.frame(
  Dataset = c("bioplex", "corum", "hippie", "random"),
  total = c(5800, 2542, 2692, 4471),
  `trans-cis` = c(21, 25, 11, 6)
)

kable(df, align = "c", caption = "Table: Total Number of Cis-Trans Pairs (p < 5e-8) by Dataset") %>%
